...
export default function SubAdminNavbar({ setIsToggled }) {
              ...
              >
                <div className="menu">
                  <ul className="menu-links" style={{ padding: "0" }}>
                    ...
                    <li className="nav-links">
                      <Link to="/student-incident-report">
                        <FontAwesomeIcon
        ...
        <div className="menu-bar">
          <div className="menu">
            <ul className="menu-links" style={{ padding: "0" }}>
              ...
              <li className="nav-links">
                <Link to="/student-incident-report">
                  <FontAwesomeIcon icon={faFileCircleXmark} className="icons" />
                  <span className="text-link">Student Incident Report</span>
                </Link>
              </li>
              <li className="nav-links">
                <Link to="/student-request">
