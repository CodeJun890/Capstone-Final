...
export default function SubAdminTopbar({
  isToggled,
  currentLocation,
  toggleSubAdminIsLoggedOut,
}) {
  const { userData } = useContext(SubAdminContext);
  const [modalShow, setModalShow] = React.useState(false);
  let topBarText = "";

  switch (currentLocation) {
    case "/subAdmin-dashboard":
    ...
    case "/student-incident-report":
      topBarText = "Dashboard | Student Incident Report";
      break;
    case "/manage-program":
    ...
    case "/manage-violations":
      ...
      break;
    case "/generate-goodmoral":
      topBarText = "Dashboard | Generate Good Moral";
      break;
    // case "/help-support":
...
function MyVerticallyCenteredModal(props) {
  const { userData, baseUrl } = useContext(SubAdminContext);
