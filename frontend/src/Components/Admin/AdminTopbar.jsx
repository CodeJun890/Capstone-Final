...
export default function AdminTopbar({
  ...
  switch (currentLocation) {
    case "/admin-dashboard":
      ...
      break;
    case "/violation-analytics":
      topBarText = "Dashboard | Violation Analytics";
      break;
    case "/subAdmin-reports":
      topBarText = "Dashboard | Sub-Admin Incident Reports";
      break;
    case "/student-request":
      topBarText = "Dashboard | Good Moral Request";
      break;
    case "/manage-students":
      topBarText = "Dashboard | Manage Students";
      break;
    case "/violation-entry":
      topBarText = "Dashboard | Add Student Violation";
      break;
    case "/manage-program":
      topBarText = "Dashboard | Manage Program";
      break;
    case "/manage-violations":
      topBarText = "Dashboard | Manage Violation List";
      break;
    case "/academic-year":
      topBarText = "Dashboard | Academic Year";
      break;
    default:
      topBarText = "Dashboard";
      break;
        ...
        <div className="top-header-cont d-flex justify-content-between align-items-center w-100">
          ...
          <div className="right-inner-header d-flex justify-content-around align-items-center">
            ...
            <div className="greet-text">
              Hi,{" "}
              <span className="fw-bold me-3 text-uppercase">
                {userData.role}
              </span>
            </div>
          </div>
...
function ChangePassword(props) {
  const { userData, baseUrl } = useContext(AdminContext);
